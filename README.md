...
- [x] Добавлены модели Category и Product
- [x] Добавлены фикстуры для моделей Category и Product
- [x] Реализована кастомная команда по удалению всех продуктов и добавлению новых из фикстуры
- [ ] ...
