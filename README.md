# Web Store
Цель данного проекта разработка функционального и привлекательного интернет-магазина
...
## Тестирование
- На данный момент тесты не проводились
...
## To do
- [x] Реализованы страницы home и contacts будущего сайта
